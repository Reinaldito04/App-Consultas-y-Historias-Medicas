...
"}")
        ...
        self.in_busqueda.setMinimumSize(QtCore.QSize(160, 40))
        self.in_busqueda.setMaximumSize(QtCore.QSize(160, 16777215))
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/home/reinaldo/Documentos/dev/App-Consultas-y-Historias-Medicas/interfaces/ELEMENTOS GRAFICOS/agg.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/home/reinaldo/Documentos/dev/App-Consultas-y-Historias-Medicas/interfaces/ELEMENTOS GRAFICOS/limpiar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.tabWidget.addTab(self.tab_make, icon5, "")
    ...
    def retranslateUi(self, Salida):
        ...
        self.in_busqueda.setPlaceholderText(_translate("Salida", "Cedula del paciente"))
        self.label_5.setText(_translate("Salida", "Controles"))
        self.btn_agg.setText(_translate("Salida", "Agregar"))
        self.btn_edit.setText(_translate("Salida", "Editar"))
