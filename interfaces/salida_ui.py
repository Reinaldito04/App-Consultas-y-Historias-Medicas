...
"}")
        ...
        self.label_14.setPixmap(QtGui.QPixmap("/home/reinaldo/Documentos/dev/App-Consultas-y-Historias-Medicas/interfaces/../../OCLUSAL.jpg"))
...
"}")
    ...
    def retranslateUi(self, Historia):
        ...
        self.label_15.setText(_translate("Historia", "Od. José R. Fernandez R "))
        self.label_21.setText(_translate("Historia", "Odontologia General e Infantil"))
        self.label_3.setText(_translate("Historia", "Fecha:"))
        self.label_4.setText(_translate("Historia", "N° de Historia:"))
        self.label_16.setText(_translate("Historia", "DATOS BASICOS DEL PACIENTE"))
        self.label_9.setText(_translate("Historia", "Cedula:"))
        self.label_11.setText(_translate("Historia", "Telefono:"))
        self.label_8.setText(_translate("Historia", "Nombre y apellido:"))
        self.label_10.setText(_translate("Historia", "Dirección:"))
        self.label.setText(_translate("Historia", "ESTADO DE SALUD GENERAL DEL PACIENTE"))
        self.lbl_2.setText(_translate("Historia", "Hipertenso:"))
        self.btn_si.setText(_translate("Historia", "Si"))
        self.btn_no.setText(_translate("Historia", "No"))
        self.label_12.setText(_translate("Historia", "Controlado:"))
        self.lbl_3.setText(_translate("Historia", "Trastorno de coagulación:"))
        self.btn_si_2.setText(_translate("Historia", "Si"))
        self.btn_no_2.setText(_translate("Historia", "No"))
        self.lbl_4.setText(_translate("Historia", "Diabetes:"))
        self.btn_si_3.setText(_translate("Historia", "Si"))
        self.btn_no_3.setText(_translate("Historia", "No"))
        self.label_13.setText(_translate("Historia", "Controlado:"))
        self.lbl_11.setText(_translate("Historia", "Alergias y habitos"))
        self.label_2.setText(_translate("Historia", "DIAGNOSTICO DEL PACIENTE"))
        self.label_6.setText(_translate("Historia", "PLAN DE TRATAMIENTOS Y COSTOS"))
        self.lineEdit_9.setPlaceholderText(_translate("Historia", "Tratamientos a realizar"))
        self.lineEdit_14.setPlaceholderText(_translate("Historia", "Bs."))
        self.lineEdit_13.setPlaceholderText(_translate("Historia", "$$$"))
        self.lineEdit_42.setPlaceholderText(_translate("Historia", "Tratamientos a realizar"))
        self.lineEdit_43.setPlaceholderText(_translate("Historia", "Bs."))
        self.lineEdit_44.setPlaceholderText(_translate("Historia", "$$$"))
        self.lineEdit_45.setPlaceholderText(_translate("Historia", "Tratamientos a realizar"))
        self.lineEdit_46.setPlaceholderText(_translate("Historia", "Bs."))
        self.lineEdit_47.setPlaceholderText(_translate("Historia", "$$$"))
        self.lineEdit_48.setPlaceholderText(_translate("Historia", "Tratamientos a realizar"))
        self.lineEdit_49.setPlaceholderText(_translate("Historia", "Bs."))
        self.lineEdit_50.setPlaceholderText(_translate("Historia", "$$$"))
        self.lineEdit_51.setPlaceholderText(_translate("Historia", "Tratamientos a realizar"))
        self.lineEdit_52.setPlaceholderText(_translate("Historia", "Bs."))
        self.lineEdit_53.setPlaceholderText(_translate("Historia", "$$$"))
        self.lineEdit_54.setPlaceholderText(_translate("Historia", "Tratamientos a realizar"))
        self.lineEdit_55.setPlaceholderText(_translate("Historia", "Bs."))
        self.lineEdit_56.setPlaceholderText(_translate("Historia", "$$$"))
        self.label_19.setText(_translate("Historia", "Monto total para el plan de tratamientos"))
        self.lineEdit_57.setPlaceholderText(_translate("Historia", "TOTALBs."))
        self.lineEdit_58.setPlaceholderText(_translate("Historia", "TOTAL $$$"))
        self.label_7.setText(_translate("Historia", "TRATAMIENTOS REALIZADOS"))
        self.label_18.setText(_translate("Historia", "FECHA:"))
        self.lineEdit_59.setPlaceholderText(_translate("Historia", "Tratamientos realizados"))
        self.lineEdit_60.setPlaceholderText(_translate("Historia", "Tratamientos realizados"))
        self.lineEdit_61.setPlaceholderText(_translate("Historia", "Tratamientos realizados"))
        self.lineEdit_62.setPlaceholderText(_translate("Historia", "Tratamientos realizados"))
        self.lineEdit_63.setPlaceholderText(_translate("Historia", "Tratamientos realizados"))
        self.lineEdit_64.setPlaceholderText(_translate("Historia", "Tratamientos realizados"))
        self.label_17.setText(_translate("Historia", "Av. 5 de Julio. Edif. Virgen Del Valle. Piso 3 - Puerto La Cruz - Edo. Anzoategui. Tlfno: 0281-9961504"))
        self.in_busqueda.setPlaceholderText(_translate("Historia", "Cedula del paciente"))
        self.label_5.setText(_translate("Historia", "Controles"))
        self.btn_agg.setText(_translate("Historia", "Agregar"))
        self.btn_edit.setText(_translate("Historia", "Editar"))
        self.btn_print.setText(_translate("Historia", "Imprimir"))
        self.btn_clear.setText(_translate("Historia", "Limpiar"))
        self.btn_xd.setText(_translate("Historia", "Cambiar"))
